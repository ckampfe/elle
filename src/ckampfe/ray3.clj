          ...
          (doseq [[ix iy] (take 1 (sort-by (fn [p]
            ...
            (let [[iinx iiny] (surface-normals-at-intersection circle-centroid
                  ...
                  [rpx rpy] (reflect-ray-off-circle circle-centroid
                                                    ...
                                                    ray-origin
                                                    [ix iy])
                  [rrpx rrpy] (m/add [ix iy] (m/mul [rpx rpy] 1000))]

              ;; the ray
              (q/with-stroke [200 20 20]
              ...
              ;; the reflection ray??????
              (q/with-stroke #_[20 200 50] [200 20 20]
        ...
        (cond
          ...
          (doseq [[ix iy] (take 1 (sort-by (fn [p]
            ...
            (let [[iinx iiny] (surface-normals-at-intersection circle-centroid
              ...
              ;; the reflection ray??????
              (q/with-stroke #_[20 200 20] [20 20 200]
                (q/line ix iy rrpx rrpy))
